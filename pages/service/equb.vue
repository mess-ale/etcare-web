                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-10">
                        <div class="">
                            <div class="saving-right-box">
                                <!-- Section Header -->
                                <h1 class="text-primary font-oswald text-2xl text-center font-bold p-4">Why Save with
                                    Us?</h1>
                        ...
                        <div class="">
                            <ul class="list-disc pl-5">
                                ...
                                <li>Digital Ekub services offered by SACCOs (Savings and Credit Cooperative
                                    Organizations) are
                                    designed to modernize the traditional Ethiopian Ekub system (a group savings and
                                    lending
                                    arrangement) using digital platforms. These services aim to increase accessibility,
                                    enhance
                                    transparency, and streamline operations. Here's an overview of the key services
                                    typically
                                    provided under digital Ekub offerings in SACCOs:
                                </li>
                            </ul>
                            ...
                            <ul class="list-disc pl-5">
                                ...
                                <li>The amount of demand savings will be determined according to the user's capacity and
                                    needs, accordingly
                                    By opening a savings account starting from 500.00 Birr, saving from 100.00 Birr
                                    after the
                                    account is
                                    opened.</li>
                            ...
                            <ul class="list-disc pl-5">
                                ...
                                <li>The deposit period is six months and the interest rate for six months is 8-12 per
                                    month The
                                    amount
                                    and
                                    duration
                                    will depend.
                                    The deposit amount is more than five hundred thousand birr If it is kept for more
                                    than two
                                    years,
                                    the interest rate is agreed upon by the management committee It will be determined
                                    but
                                    should
                                    not
                                    exceed
                                    13.5
                                    percent. </li>
                                <li>According to the agreement that the cooperative makes with its members as necessary,
                                    for a
                                    certain
                                    period
                                    Time
                                ...
                                <li>The cooperative can encourage time saving It will be only when it is confirmed that
                                    ...
                                    to
                                    use it is high.</li>
                                <li> Time limit savings for loan guarantee until the guarantee is lifted as a cost to
                                    the member
                                    not
                                    paid
                                </li>
                            ...
                            <ul class="list-disc pl-5">
                                ...
                                <li>The right of the savings member to claim interest in any case He will not have it,
                                    but if he
                                    requests to be considered for interest in the application, the interest will be
                                    granted will
                                    benefit
                                </li>
                            ...
                            <ul class="list-disc pl-5">
                                ...
                                <li>The importance of having children's savings so that they have an understanding of
                                    the
                                    cooperative
                                ...
                                <li>Children who have been saving in the cooperative and reached the age of 18 If you
                                    meet the
                                    other
                                    requirements for registration fee, you can become a member by purchasing a lot at
                                    the
                                    association.
                                </li>
                            ...
                            <ul class="list-disc pl-5">
                                ...
                                <li>Women will get interest on their savings but the interest on savings will be added
                                    to the
                                    savings.
                                </li>
