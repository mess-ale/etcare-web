  ...
  <div class="p-6 max-w-4xl mx-auto body-padding_margin">
    <div class="container">
      ...
      <div v-if="blogData && !isLoading" class="space-y-6 py-32">
        <h1 class="text-3xl font-bold text-primary">{{ blogData.title }}</h1>
        ...
        <div class="flex justify-between space-x-12 pt-2 social-link">
          <nuxt-link to="https://web.facebook.com/etcaresacco" target="_blank"><svg class="socialM about-link"
              xmlns="http://www.w3.org/2000/svg" width="2.7em" height="2.7em" viewBox="0 0 24 24">
          ...
          <nuxt-link to="https://www.youtube.com/@etcarebeautyandcosmeticssales" target="_blank">
            <svg class="socialM about-link" xmlns="http://www.w3.org/2000/svg" width="2.7em" height="2.7em"
              viewBox="0 0 24 24">
              <path fill="currentColor"
          ...
          <nuxt-link to="https://vm.tiktok.com/ZMhQxWYC7/" target="_blank"> <svg class="socialM about-link"
              xmlns="http://www.w3.org/2000/svg" width="2.7em" height="2.7em" viewBox="0 0 24 24">
              <path
          ...
          <nuxt-link to="https://t.me/etcaresacco" target="_blank"><svg class="socialM about-link"
              xmlns="http://www.w3.org/2000/svg" width="2.7em" height="2.7em" viewBox="0 0 24 24">
              <path
