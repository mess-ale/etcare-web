                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-10">
                    <div class="">
                        <div class="saving-right-box">
                            <!-- Section Header -->
                            <h1 class="text-primary font-oswald text-2xl text-center font-bold xxxs:p-2 md:p-4">Why Save
                                with Us?</h1>

                            <!-- Feature List -->
                            <div class="space-y-2">
                                <!-- Feature Item -->
                                <div class="flex gap-4 xxxs:p-2 md:p-4 border-b border-gray-200">
                    ...
                    <div>
                        <ul class="list-disc pl-5">
                            ...
                            <li>Standard Savings, Interest Savings, Time Limit Savings, as defined in the
                                Cooperative's Articles of Association Interest Free Savings, Child Savings and Home
                                Savings,
                                Transport Car Savings,
                                Automobile
                                Car
                            </li>
                        </ul>
                        ...
                        <ul class="list-disc pl-5">
                            ...
                            <li>Standard savings rate is based on the member's saving capacity and is based on the
                                member's
                                application It must be approved by the cooperative.</li>
                        ...
                        <ul class="list-disc pl-5">
                            ...
                            <li>The deposit period is six months and the interest rate for six months is 8-12 per month
                                The
                                amount and duration will depend. The deposit amount is more than five hundred thousand
                                birr
                                If
                                it is kept for more than two years, the interest rate is agreed upon by the management
                                committee
                                It will be determined but should not exceed 13.5 percent. </li>
                            <li>According to the agreement that the cooperative makes with its members as necessary, for
                                a
                                certain period Time may accrue a non-payable time limit savings to the depositor;</li>
